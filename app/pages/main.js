                ...
                <Layout style={{height:600}}>
                    <Sider width={200} collapsedWidth="50" style={{background: '#fff'}} collapsible="false">
                        ...
                        >
                            <SubMenu key="sub1" title={<span><Icon type="home"/>商品</span>}>
                                <Menu.Item key="1"><Link to={`${this.props.match.url}/goods/query`}>查看</Link></Menu.Item>
                                <Menu.Item key="2"><Link to={`${this.props.match.url}/goods/add`}>添加</Link></Menu.Item>
                            ...
                            <SubMenu key="sub2" title={<span><Icon type="laptop"/>商品分类</span>}>
                                <Menu.Item key="5"><Link to={`${this.props.match.url}/goodsCategory/query`}>查看</Link></Menu.Item>
                                <Menu.Item key="6"><Link to={`${this.props.match.url}/goodsCategory/add`}>添加</Link></Menu.Item>
                                <Menu.Item key="7"><Link to={`${this.props.match.url}/goodsCategory/delete`}>删除</Link></Menu.Item>
                            </SubMenu>
                            <SubMenu key="sub3" title={<span><Icon type="notification"/>订单</span>}>
                                <Menu.Item key="9"><Link to={`${this.props.match.url}/order/query`}>查看</Link></Menu.Item>
                                <Menu.Item key="10"><Link to={`${this.props.match.url}/order/add`}>添加</Link></Menu.Item>
                                <Menu.Item key="11"><Link to={`${this.props.match.url}/order/delete`}>删除</Link></Menu.Item>
                            </SubMenu>
                        </Menu>
                    </Sider>
                    ...
                    <Layout style={{padding: '0 24px 24px'}} >
                        ...
                        <Content style={{background: '#F6FAFE', padding: 0, margin: 0, height: '100%'}}>
                            ...
                            <Route path={`${this.props.match.url}/goodsCategory/:action`} component={GoodsCategoryView} />
